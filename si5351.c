...
static void set_frequency_fixedpll(int clk, int pll, uint32_t pllfreq, uint32_t freq,
                                   int rdiv, uint8_t drive_strength) {
...
static void set_freq_fixeddiv(int clk, int pll, uint32_t frequency, int divider, 
                              uint8_t drive_strength) {
